  ...
  return (
    <section className="bg-gradient-to-br from-white via-[#F9F3EF]/20 to-white rounded-2xl shadow-lg p-6 md:p-10">
      ...
      >
        ...
        <p className="text-[#1B3C53]/70 ml-5 text-sm md:text-base">
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <div className="bg-gradient-to-br from-[#F9F3EF] to-white rounded-xl p-6 border border-[#F9B572]/20 shadow-md">
            ...
            <div className="space-y-4">
              {contactInfo.map((item, index) => (
                <motion.a
                  ...
                  whileHover={{ x: 5 }}
                  className="flex items-center gap-4 p-4 bg-white rounded-lg border border-[#1B3C53]/10 hover:border-[#F9B572]/40 hover:shadow-md transition-all group"
                >
                  <div className={`p-3 bg-gradient-to-br ${item.color} rounded-lg shadow-sm`}>
                  ...
                  <FaPaperPlane className="text-[#F9B572] opacity-0 group-hover:opacity-100 transition-opacity" />
                </motion.a>
              ))}
            </div>
          </div>
        ...
        >
          <div>
            <label className="block text-sm font-semibold text-[#1B3C53] mb-2">Your Name</label>
            <input
              type="text"
              name="name"
              ...
              required
              className="w-full border border-[#1B3C53]/20 focus:border-[#F9B572] focus:ring-2 focus:ring-[#F9B572]/20 outline-none p-4 rounded-xl text-sm transition-all bg-white shadow-sm hover:shadow-md"
            />
          </div>
          
          <div>
            <label className="block text-sm font-semibold text-[#1B3C53] mb-2">Your Email</label>
            <input
              type="email"
              name="email"
          ...
          <div>
            <label className="block text-sm font-semibold text-[#1B3C53] mb-2">Your Message</label>
            <textarea
              name="message"
              rows="6"
              ...
              onChange={handleChange}
              required
              className="w-full border border-[#1B3C53]/20 focus:border-[#F9B572] focus:ring-2 focus:ring-[#F9B572]/20 outline-none p-4 rounded-xl text-sm transition-all bg-white shadow-sm hover:shadow-md resize-none"
            ></textarea>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-gradient-to-r from-[#1B3C53] to-[#2d5573] text-white py-4 rounded-xl text-sm font-bold hover:shadow-xl transition-all flex items-center justify-center gap-2 group"
          >
